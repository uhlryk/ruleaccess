 ...
 */
ruleFunctionList.alwaysAllowRule = function(userResource, params, ruleParams, resource){
	return true;
};
/**
 * dummy ruleFunction which always return false.
 */
ruleFunctionList.alwaysDisallowRule = function(userResource, params, ruleParams, resource){
	return false;
};
/**
 ...
 */
ruleFunctionList.simpleRoleRule = function(userResource, params, ruleParams, resource){
	return false;
};
